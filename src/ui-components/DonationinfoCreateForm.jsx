...
export default function DonationinfoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPhoto_url(initialValues.photo_url);
    setUsername(initialValues.username);
    setTrackid(initialValues.trackid);
    setDate(initialValues.date);
    setDeliverycompany(initialValues.deliverycompany);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Donationinfo(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "DonationinfoCreateForm")}
      {...rest}
    >
      <TextField
        label="Address"
